...
class AutoEncoder(nn.Module):
    ...
    def encode_with_internals(self, x, scale_schedule):
        h, z, all_indices, all_bit_indices, residual_norm_per_scales, var_input = self.encode(x, scale_schedule)
        codebook_loss = torch.mean((h - z) ** 2)
        return all_bit_indices,h,z,codebook_loss
