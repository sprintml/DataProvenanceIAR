...
from deps.taming.modules.util import SOSProvider
from deps.taming.util import instantiate_from_config
...
class Net2NetTransformer(pl.LightningModule):
    def __init__(self,
        ...
        if permuter_config is None:
            permuter_config = {"target": "deps.taming.modules.transformer.permuter.Identity"}
